...
def updateVeiculo(id: int, modelo: str, marca: str, ano_fabricacao: int, placa: str, valor_diaria: Decimal, quilometragem_atual: int, disponivel: bool):
    ...
    veiculo_existente = get_veiculo_by_placa(placa)
    if veiculo_existente and veiculo_existente.id != id:
        raise ValueError("Placa já cadastrada no sistema para outro veículo.")
